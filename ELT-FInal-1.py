...
# Main ELT Process
def main():
    exchange_rates_path = 'C:/testing/exchange_rate.csv'  # Replace with the actual path to your CSV
    ...
    # Transform (Now, we directly transform the data in Python after extraction, without reloading from SQL)
    transformed_data = transform(extracted_data,exchange_rates)
    log_progress("Data transformed in Python")

    # The transformed data is now ready for analysis or other operations within Python
    print(transformed_data.head())  # Display the first few rows of the transformed DataFrame
